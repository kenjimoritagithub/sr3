...
save data_figure8Ca totalRset
heatmap_performance(mean(totalRset,3),length(a_posiprop_set),[],'Figure8Ca');
...
save data_figure8Cb totalRset
heatmap_performance(mean(totalRset,3),length(a_posiprop_set),[],'Figure8Cb');
...
save data_figure8E-G totalRset
% top images
tmp_letters = 'EFG';
for k_model = 1:3
...
for k_model = 1:3
    ...
    print(F,'-depsc',['Figure8' tmp_letters(k_model) 'bottom']);
end
